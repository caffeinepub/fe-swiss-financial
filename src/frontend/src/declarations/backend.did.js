...
export const idlService = IDL.Service({
  ...
  'getAdminEntries' : IDL.Func([], [IDL.Vec(AdminEntry)], []),
  'getAdminEntry' : IDL.Func([IDL.Principal], [AdminEntry], ['query']),
  'getAdminList' : IDL.Func([], [IDL.Vec(AdminEntry)], []),
  'getAdminListSize' : IDL.Func([], [IDL.Nat], ['query']),
  ...
  'getMyAdminEntry' : IDL.Func([], [IDL.Opt(AdminEntry)], []),
